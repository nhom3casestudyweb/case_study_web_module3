                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img height="100px"
                                     src="https://bachma.vn/wp-content/uploads/2022/01/ghe-cong-thai-hoc-gia-re.jpg"
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form action="/account" method="post">
                                        ...
                                        <div class="form-outline mb-4">
                                            <label class="fw-normal mb-3 pb-3" for="userName">Tên Đăng
                                                Nhập:&nbsp;</label>
                                            <label class="fw-normal mb-3 pb-3">${userName}</label>
                                            <input type="email" id="userName" name="userName" hidden="hidden"
                                                   value="${userName}"
                                        ...
                                        <div class="pt-1 mb-4">
                                            ...
                                            <a href="/accountServlet?action=login">
