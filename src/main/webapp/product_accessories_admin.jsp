    ...
    <div class="offcanvas-body">
        ...
        <div class="dropdown mt-3">
            ...
            <ul class="dropdown-menu">
                <li><a style="font-weight: bold" class="dropdown-item" href="/product-servlet?action=showListChairAdmin">Ghế công thái học</a></li>
                <li><a style="font-weight: bold" class="dropdown-item" href="/product-servlet?action=showListDeskAdmin">Bàn công thái học</a></li>
                <li><a style="font-weight: bold" class="dropdown-item" href="/product-servlet?action=showListAccessoriesAdmin">Phụ kiện công thái học</a></li>
