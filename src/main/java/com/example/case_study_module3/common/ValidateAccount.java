package com.example.case_study_module3.common;
...
public class ValidateAccount {
    ...
    public static String checkUserName(String userName) {
        if (userName == null || userName.trim().equals("")) {
            ...
            return "Tài khoản đăng nhập giới hạn 255 kí tự!";
        }
        return null;
    }
    ...
    public static String checkConfirmPassword(String confirmPassword) {
